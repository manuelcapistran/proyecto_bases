...
CREATE TABLE LICENCIA (
    ...
    FOTO                BLOB            NOT NULL,
    FIRMA               BLOB            NOT NULL,
    HUELLA_INDICE_DER   BLOB            NOT NULL, 
    ...
    FECHA_VENCIMIENTO   DATE GENERATED ALWAYS AS (
        CASE 
            WHEN TIPO IN ('A', 'B') THEN ADD_MONTHS(FECHA_EMISION, 36) 
            WHEN TIPO = 'C' THEN ADD_MONTHS(FECHA_EMISION, 48)        
        END
    ) STORED NOT NULL,
...
CREATE TABLE VERIFICACION (
    ...
    FECHA_VERIFICACION DATE DEFAULT SYSDATE NOT NULL, 
